...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/com.anvesh.devopsDataSource" pool-name="com.anvesh.devopsDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/com.anvesh.devopsDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="com.anvesh.devopsSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/com.anvesh.devopsDataSource"/>
